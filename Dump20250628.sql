...
CREATE TABLE `log_pedidos` (
  ...
  `nuevo_estado` enum('pendiente','preparado','listo','entregado') DEFAULT NULL,
  ...
  CONSTRAINT `log_pedidos_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`)
...
INSERT INTO `usuarios` VALUES (1,'mila','mila@gmail.com','$2y$10$YmNTgH134IGNitc/uPWYpextxJtMWqc4P4mU4uvGgrqEG1/SHATOm','cliente','2025-06-28 00:17:48');
...
-- Dump completed on 2025-06-28  8:38:33
